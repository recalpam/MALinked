<div id="searchModal" class="reveal-modal" data-reveal aria-hidden="true" role="dialog">
	<div class="search-bar full-row">
		...
		<div class="search">
			<input id="live-search-input" name="search-bar" ng-model="search" placeholder="Zoek direct op een opleiding, klas of student" onfocus="this.placeholder=''" onblur="this.placeholder='Zoek direct op een opleiding, klas of student'">
